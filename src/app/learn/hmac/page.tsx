    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-slate-200 font-mono tracking-widest uppercase m-0">Module 3 — HMAC Algorithms</h4>
            </div>
            ...
            <div className="not-prose bg-muted/40 border-l-4 border-primary p-8 rounded-r-3xl my-16 group relative overflow-hidden shadow-2xl shadow-black/40">
                ...
                <h3 className="text-2xl font-bold font-mono text-white mb-6">⚙️ Technical Blueprint: The Dual Pass</h3>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="p-3 bg-white/5 rounded border border-white/5 flex items-center justify-between">
                                <span className="text-[10px] text-white">1. Key Vectorization</span>
                                <span className="text-[10px] text-green-500 font-mono">B-bit padding</span>
                            </div>
                            <div className="p-3 bg-white/5 rounded border border-white/5 flex items-center justify-between">
                                <span className="text-[10px] text-white">2. Inner Hash Pass</span>
                                <span className="text-[10px] text-blue-500 font-mono">XOR with ipad</span>
                            </div>
                            <div className="p-3 bg-white/5 rounded border border-white/5 flex items-center justify-between">
                                <span className="text-[10px] text-white">3. Outer Hash Pass</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12 not-prose">
                ...
                <div className="bg-muted/10 border border-border p-6 rounded-2xl flex flex-col justify-center">
                    <h4 className="text-sm font-bold text-white mb-2 uppercase tracking-widest">Why use HMAC over Signatures?</h4>
