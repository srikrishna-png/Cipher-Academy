    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-foreground/60 font-mono tracking-widest uppercase m-0">Module 10 — Key Generation</h4>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12 not-prose">
                <div className="bg-muted/10 border border-border p-6 rounded-2xl">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between text-[10px] font-mono">
                            <span className="text-foreground dark:text-white">RSA-4096 Generation:</span>
                            <span className="text-red-400">~2,500ms</span>
                        </div>
                        <div className="flex justify-between text-[10px] font-mono">
                            <span className="text-foreground dark:text-white">P-256 Generation (ECC):</span>
                ...
                <div className="bg-black/60 p-6 rounded-2xl border border-white/5 flex flex-col justify-center">
                    <h5 className="text-xs font-bold text-foreground dark:text-white mb-3 uppercase tracking-widest">The "Key Trapdoor"</h5>
